                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div class="d-flex gap-2">
                            ...
                            @if(auth()->check() && auth()->user()->username !== 'guest' && (auth()->user()->isMaster() || in_array(auth()->user()->username, ['master', 'admin'])))
                    ...
                    <div class="table-responsive" style="max-height: 550px; overflow-y: auto;">
                        <table class="table table-striped table-bordered" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <div class="filter-header">
                                            <span>User</span>
                                            <select class="form-select form-select-sm filter-select" data-column="8"
                            ...
                            <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <button type="button" class="btn btn-sm btn-warning edit-item-btn"
                                                        data-id="{{ $item['id'] }}" data-item-code="{{ $item['item_code'] ?? '' }}"
                                                        ...
                                                        data-user="{{ $item['user'] ?? '' }}"
                                                        data-outstanding-pp="{{ $item['outstanding_pp'] ?? '' }}" title="Edit">
                                                        <i data-feather="edit" class="icon-sm"></i>
                                                    </button>
                                                    <form action="{{ route('item_master.destroy', $item['id']) }}" method="POST"
                                                        class="d-inline"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="{{ auth()->check() && (auth()->user()->isMaster() || in_array(auth()->user()->username, ['master', 'admin'])) ? 13 : 12 }}"
                                            class="text-center text-muted">Belum ada data master item</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="pages[]" value="data_master"
                                    id="page_data_master">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="pages[]" value="item_outstanding"
                                    id="page_item_outstanding">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="pages[]" value="history"
                                    id="page_history">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="pages[]" value="import_summary"
                                    id="page_import_summary">
                            ...
                            <div class="form-check mt-2">
                                <input class="form-check-input" type="checkbox" name="pages[]" value="data_po"
                                    id="page_data_po">
