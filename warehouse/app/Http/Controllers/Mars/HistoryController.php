...
class HistoryController extends Controller
{
    ...
    public function index()
    {
        ...
        $historyItems = $historyData->map(function ($item) {
            return [
                ...
                'po_no' => $item->po_no,
                'jumlah_item_datang' => $item->arrived_qty,
        ...
        return view('mars.history', compact('historyItems'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('mars.history.index')->with('success', $message);
    ...
    public function bulkDestroy(Request $request)
    {
        ...
        if (empty($ids) || !is_array($ids)) {
            return redirect()->route('mars.history.index')->with('error', 'Tidak ada item yang dipilih untuk dihapus.');
        }
        ...
        try {
            ...
            return redirect()->route('mars.history.index')->with('success', count($ids) . ' item history berhasil dihapus.');
        } catch (\Exception $e) {
            DB::rollBack();
            return redirect()->back()->with('error', 'Error deleting history: ' . $e->getMessage());
        }
    ...
    public function export(Request $request)
    {
        ...
        $headers = [
            'No', 'Item Code', 'Item Name', 'Supplier Name',
            'Sched. Receipt Qty.', 'PO No.', 'Jumlah Item yang Datang',
            'Tanggal Kedatangan', 'Pengiriman Tanggal',
        ];
